  ...
  Courses.insert {
    ...
    schedule: {
      saturday: [
          ...
          ['13:00', 'Встречаемся, базарим по душам но на этот раз по-долльше']
          ['15:00', 'Встречаемся, базарим по душам йеху']
          ['17:00', 'Встречаемся, базарим по душам']
          ['19:00', 'Встречаемся, базарим по душам']
        ]
      sunday: [
        ['12:00', 'Встречаемся, базарим по душам']
        ['13:00', 'Встречаемся, базарим по душам но на этот раз по-долльше']
